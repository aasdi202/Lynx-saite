const supportedLangs = ["en", "fa", "zh", "ru", "tr", "ar"];

// بررسی زبان انتخاب‌شده در حافظه مرورگر یا زبان مرورگر کاربر
let lang = localStorage.getItem("lynx-lang");
if (!lang) {
  const browserLang = navigator.language.slice(0, 2);
  lang = supportedLangs.includes(browserLang) ? browserLang : "en";
  localStorage.setItem("lynx-lang", lang);
}
